...
const Header = () => {
    ...
    return (
        <header className='flexd z-[200] right-0 left-0 top-0 bg-transparent'>
            ...
            <div className="w-full relative">
                ...
                <div className={`${isScroll ? "px-0" : "3xl:px-[100px] px-[1%]  "}`}>

                    <nav className={`bg-white w-full py-4 px-2 lg:px-4 rounded-md shadow`}>
                        <div className={`container mx-auto ${isScroll && "lg:px-[118px] px-[1%]"}`}>
